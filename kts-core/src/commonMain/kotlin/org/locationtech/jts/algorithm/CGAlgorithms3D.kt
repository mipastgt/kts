 ...
 *
 */
class CGAlgorithms3D private constructor() {

  companion object {
    @JvmStatic
    fun distance(p0: Coordinate, p1: Coordinate): Double {
    ...
    @JvmStatic
    fun distancePointSegment(p: Coordinate, A: Coordinate, B: Coordinate): Double {
     ...
     */
    @JvmStatic
    fun distanceSegmentSegment(A: Coordinate, B: Coordinate, C: Coordinate, D: Coordinate): Double {
      /*
