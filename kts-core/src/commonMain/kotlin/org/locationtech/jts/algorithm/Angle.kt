...
class Angle private constructor() {
  ...
  companion object {
     ...
     */
    @JvmField
    val PI_TIMES_2 = 2.0 * PI

    /**
     * The value of Pi/2
     */
    @JvmField
    val PI_OVER_2 = PI / 2.0

    /**
     * The value of Pi/4
     */
    @JvmField
    val PI_OVER_4 = PI / 4.0
     ...
     */
    @JvmStatic
    fun toRadians(angleDegrees: Double): Double {
     ...
     */
    @JvmStatic
    fun angleBetween(tip1: Coordinate, tail: Coordinate, tip2: Coordinate): Double {
     ...
     */
    @JvmStatic
    fun angleBetweenOriented(tip1: Coordinate, tail: Coordinate, tip2: Coordinate): Double {
      val a1 = angle(tail, tip1)
      val a2 = angle(tail, tip2)
      val angDel = a2 - a1
     ...
     */
    @JvmStatic
    fun bisector(tip1: Coordinate, tail: Coordinate, tip2: Coordinate): Double {
    ...
    fun getTurn(ang1: Double, ang2: Double): Int {
      val crossproduct = sin(ang2 - ang1)
     ...
     */
    @JvmStatic
    fun diff(ang1: Double, ang2: Double): Double {
      var delAngle: Double
     ...
     */
    @JvmStatic
    fun sinSnap(ang: Double): Double {
      val res = sin(ang)
      if (abs(res) < 5e-16) return 0.0
      return res
    }
    ...
    fun project(p: Coordinate, angle: Double, dist: Double): Coordinate {
      val x = p.getX() + dist * cosSnap(angle)
      val y = p.getY() + dist * sinSnap(angle)
