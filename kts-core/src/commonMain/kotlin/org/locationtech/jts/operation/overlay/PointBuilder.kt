...
class PointBuilder(
  ...
  private val resultPointList: MutableList<Point> = ArrayList()
  ...
  /**
   * Determines nodes which are in the result, and creates [Point]s for them.
   *
   ...
   */
  private fun extractNonCoveredResultNodes(opCode: Int) {
    // testing only
