...
interface UnionStrategy {
     ...
     * This method may throw a [org.locationtech.jts.geom.TopologyException]
     ...
     * can make use of the [OverlapUnion] performance optimization,
     ...
     */
    fun isFloatingPrecision(): Boolean
}
