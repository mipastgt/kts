...
public abstract class GeometryTestCase extends TestCase{
   ...
   */
  public static WKTReader getWKTReader(Set<Ordinate> ordinateFlags) {
   ...
   * @return a {@code WKTReader}
   */
  public static WKTReader getWKTReader(Set<Ordinate> ordinateFlags, double scale) {
   ...
   * @return a {@code WKTReader}
   */
  public static WKTReader getWKTReader(Set<Ordinate> ordinateFlags, PrecisionModel precisionModel) {
   ...
   */
  public static CoordinateSequenceFactory getCSFactory(Set<Ordinate> ordinateFlags)
  {
