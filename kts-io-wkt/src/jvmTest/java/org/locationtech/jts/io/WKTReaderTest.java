...
public class WKTReaderTest extends GeometryTestCase {
  ...
  private static CoordinateSequence[] createSequences(Set<Ordinate> ordinateFlags, double[][] xyarray) {
  ...
  private static CoordinateSequence createSequence(Set<Ordinate> ordinateFlags, double[] xy) {
  ...
  private static int requiredDimension(Set<Ordinate> ordinateFlags)
  {
    return ordinateFlags.size();
  }


  private static double[] injectZM(Set<Ordinate> ordinateFlags, double[] xy) {
