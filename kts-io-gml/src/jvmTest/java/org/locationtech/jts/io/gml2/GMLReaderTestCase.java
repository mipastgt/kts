...
public class GMLReaderTestCase extends TestCase 
{
	...
	public void testPointRead() throws IOException, ParseException{
		FileReader fr = new FileReader(TEST_DIR + "points.xml");
		
		GMLReader gr = new GMLReader();
		Geometry g = GMLExtensions.read(gr, fr, geometryFactory);
	...
	public void testLineStringRead() throws IOException, ParseException{
	...
	public void testPolygonRead() throws IOException, ParseException{
	...
	public void testMultiPointRead() throws IOException, ParseException{
	...
	public void testMultiLineStringRead() throws IOException, ParseException{
	...
	public void testMultiPolygonRead() throws IOException, ParseException{
